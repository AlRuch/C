...
void checker(int p,int q);
void donut(int p,int q);
...
int p,q;
	...
	if (!strcmp(argv[1],"checker")){//identify the checker function


    checker(p,q);

 }else if(!strcmp(argv[1],"donut")){//identify the donut function
 ...
 printf("Requested figure is not available \n");
  ...
  printf("Too many arguments \n");}
        ...
        void checker(int p,int q){//checker function
...
void donut(int p,int q){//donut function
